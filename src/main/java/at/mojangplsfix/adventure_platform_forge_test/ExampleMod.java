package at.mojangplsfix.adventure_platform_forge_test;
...
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.audience.Audience;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.bossbar.BossBar;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.inventory.Book;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.key.Key;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.sound.Sound;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.text.Component;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.text.event.ClickEvent;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.text.event.HoverEvent;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.text.format.NamedTextColor;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.text.format.Style;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.text.format.TextColor;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.text.format.TextDecoration;
import net.kyori.adventure.platform.forge.shadow.net.kyori.adventure.title.Title;
    ...
    public static void command(RegisterCommandsEvent event) {
        event.getDispatcher().register(
            Commands.literal("adventure")
                .then(Commands.literal("help").executes(ExampleMod::getHelp))
                .then(Commands.literal("message").executes(ExampleMod::regularMessage))
                .then(Commands.literal("status").executes(ExampleMod::status))
                .then(Commands.literal("title").executes(ExampleMod::title))
                .then(Commands.literal("bossbar").executes(ExampleMod::bossBar))
                .then(Commands.literal("sound").executes(ExampleMod::sound))
                .then(Commands.literal("book").executes(ExampleMod::book))
        );
    }
